<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0">
        ...
        <span class="ms-1 font-weight-bold">Meetmens</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="hitung.php">
            ...
            <span class="nav-link-text ms-1">Penghitung Mens</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="kalender.php">
            ...
            <span class="nav-link-text ms-1">Kalender Mens</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="curhat.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>spaceship</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Curhatan Gadis</span>
          </a>
        </li>
...
<?php if (isset($_SESSION['admin_akses'])) { ?>
        ...
        <?php  if (in_array("penulis", $_SESSION['admin_akses']) OR in_array("admin", $_SESSION['admin_akses'])) { ?>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="penulis.php">
            ...
            <span class="nav-link-text ms-1">Tulis Artikel</span>
          </a>
        </li>
...
<?php if (isset($_SESSION['admin_akses'])) { ?>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="tampilakun.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>customer-support</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
